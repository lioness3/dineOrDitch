...
let DateIdeas = [
    ...
    {title:'Go Camping', description: 'Whether you like to "Glamp" or rough it, being in nature will ground you both.'},
    {title:'Play a Messy Game of Twister', description: 'Take it to the backyard and play a game of messy Twister. The same rules apply, but put coordinated paint colors on the Twister circles and let the games begin!'},
    ...
    {title:'Build a Slip ‘N Slide', description: 'Set up a Slip ‘N Slide in your backyard. Not only is this silly date a sure-fire hit, but it’s a refreshing way for the two of you to cool off in the summer heat.'},
    {title:'Give Eachother Massages', description: 'Light some candles, break out the lotion or oil, and give each other a nice long back-rub. You’ll both get a chance to unwind (while knowing that you’re not on the clock and paying for every minute of enjoyment).'},
    {title:'Go For a Swim', description: 'Be sure to bring towels to dry off...'},
